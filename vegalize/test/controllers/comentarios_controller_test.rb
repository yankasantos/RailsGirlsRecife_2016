...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { mensagem: @comentario.mensagem, restaurante_id: @comentario.restaurante_id, usuario: @comentario.usuario } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { mensagem: @comentario.mensagem, restaurante_id: @comentario.restaurante_id, usuario: @comentario.usuario } }
